...
TRAJECTORY_BUILDER_3D.scans_per_accumulation = 5--160
...
SPARSE_POSE_GRAPH.optimize_every_n_scans = 30--320
SPARSE_POSE_GRAPH.constraint_builder.sampling_ratio = 0.03
SPARSE_POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 100--10
